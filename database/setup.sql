-- ============================================
-- Porra del Sanedrín - Database Setup Script
-- ============================================
-- ⚠️ IMPORTANT: Run database/base-schema.sql FIRST before running this script!
-- This script creates additional tables and functions needed for the application
-- Run this in your Supabase SQL Editor AFTER base-schema.sql
...
-- Drop and recreate news tables to ensure correct schema
...
-- Helper Functions
-- ============================================
-- Note: These functions require base tables from base-schema.sql to exist
-- (matches, participant_selections, season_participants, participant_match_points, users)
...
COMMENT ON TABLE news IS 'News and announcements for the league';
COMMENT ON TABLE season_config IS 'Configuration settings for each season';
COMMENT ON TABLE team_name_mappings IS 'Mapping between API team names and database team IDs';
COMMENT ON FUNCTION calculate_match_points IS 'Calculates and stores points for all participants affected by a match';
COMMENT ON FUNCTION get_participant_standings IS 'Returns current standings for a season';
